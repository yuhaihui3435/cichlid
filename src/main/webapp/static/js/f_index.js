                ...
                $.each(rs,function (index,d) {
                    ...
                    if(d.thumbnail!=''){
                        ...
                        html=html+"<span class=\"product-description \">"
                            +"英文名:"+d.enName+"</span><span class=\"product-description\">地域:"+d.areaTxt+"</span><span class=\"product-description\">亚群体:"+d.sgTxt+"</span><span class=\"product-description\">属种:"+d.speciesTxt
                            +"</span></div></li>";
                        ...
                        html="<li class=\"item\">"
                            ...
                            +"</div>"
                            +"<div class=\"product-info\">"
                            +"<a href=\""+basePath+"/view?id="+d.id+"\" class=\"product-title\">";
